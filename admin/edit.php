...
$table = mysqli_query($con, $sql);
    ...
    else
    {
        ...
        if($er == 0)
        {
            ...
            {
                print '<span>'.mysqli_error($con).'</span>';
            }
        }
    }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="right-side-form">
                                        ...
                                        <p><!--suppress HtmlFormInputWithoutLabel -->
                                            <input type="text" name="class" value="<?php print $row['class']; ?>"></p>

                                        <h5><label for="shift">Mode of Study</label></h5>
                                        <p><!--suppress HtmlFormInputWithoutLabel -->
                                        ...
                                        <p><!--suppress HtmlFormInputWithoutLabel -->
                                            <input type="text" name="blgroup" value="<?php print $row['blgroup']; ?>"></p>
